...
(2, '系統管理員', '2018-06-22 00:34:08', '星巴克買一送一二三', '       具與UTF8中文亂碼的終極研究這篇不是探討SEO， 出現在AdSenseor或許有些奇怪，不過因為最近筆者勤於備份資料，而且試著把建立起資料a   bb');
...
(1, '中式燉肉末佐青蔥青菜細麵', '中式主餐', 80, '../img/pic1.png'),
(2, '油香煎餅佐嫩綠青蔥', '中式附餐', 60, '../img/pic2.jpg'),
(3, '法是焗香奶油煎餅佐相思豆泥', '法式甜點', 60, '../img/pic3.jpg'),
(4, '中式燉飯佐甘署', '中式主餐', 60, '../img/pic4.jpg'),
(7, '包子拉', '一半的包子', 100, '../img/pic5.jpg');
...
(1, '伯朗買一送一', '故事圍繞著三個仿生人', 0, '2018-06-28 13:43:57', ''),
(2, '西雅圖買一送一', '西雅圖，是美國華盛頓州的一座港口城市', 1, '2018-06-28 13:45:15', 'b'),
(11, '便當1個30', '排骨飯60元', 0, '2018-06-28 13:44:02', ''),
(16, 'aa', 'aaaa', 1, '2018-06-28 13:44:24', 'a');
