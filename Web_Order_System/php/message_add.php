        ...
        <span class="message_add">新增主題</span>
            ...
            <?php if($submit == ""){ //如果按送出按鈕後 是空白的話就顯示出編輯畫面?>  
                ...
                <span class="message_add_no_c">編號 No：</span>
                    ...
                    <input type="text" id="message_add_name" name="message_add_name" class="message_add_textbox2" value="<?php echo '系統管理員' ?>" placeholder="請輸入發布人姓名" autocomplete="off" disabled>
                    ...
                    <a href="root.php" style="text-decoration: none;"><span  class="message_add_return">返回</a></span>
                </form>
                <?php } 
                ...
                { 
                    ...
                    //SQL新增
                    $sql_message_add= "INSERT INTO  message  VALUES ('','$message_add_title','$message_add_content','0','$currtime','')" ;
