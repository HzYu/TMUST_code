...
<html>
    <head>
        <meta charset="utf-8">
        <link href="../css/message1_mem.css" rel="stylesheet" type="text/css">
    ...
    <body>
        <div class="message_theme">
            ...
            <?php
                echo "<span class='message_name1'>".  $username .'_一般會員'."</span>";
            ?>

            <a href="member.php" style="text-decoration: none;"><span  class="message_return hvr-underline-reveal">返回</a></span>
            <?php
            echo "<a href='message_del_mem.php?id=$no' style='text-decoration: none;'><span  class='message_del hvr-underline-reveal'>刪除主題</a></span>"
            ?>
            <table border="0" class="message_box1">
                ...
                <tr align=center class="message_item1 hvr-bubble-right">
                ...
                <?php      
                    ...
                    {
                        echo "<tr align=center class='message_item1 hvr-bubble-right'>";
