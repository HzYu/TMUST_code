...
<?php
  ...
  echo"<p style='text-align:center;'><a href='score1.php?op=add'>新增資料</a></p>";
  ...
  while($rs=mysql_fetch_array($results)) //索引值可以是數字和字串
  {
	   ...
	   */
	  echo "<td>"."<a href='score1.php?op=edit&id=$rs[id]'>修改</a>"."<a href='score1.php?op=del&id=$rs[id]'> / 刪除</a>"; // id放在網址後方 方便新增刪除使用
	  echo "</tr>";
  }
?>
</table>
